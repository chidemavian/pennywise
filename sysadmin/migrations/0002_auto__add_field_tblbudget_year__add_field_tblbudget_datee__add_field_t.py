...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'tblbudget.year'
        db.add_column(u'sysadmin_tblbudget', 'year',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=375),
                      keep_default=False)

        # Adding field 'tblbudget.datee'
        db.add_column(u'sysadmin_tblbudget', 'datee',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=20),
                      keep_default=False)

        # Adding field 'tblbudget.timee'
        db.add_column(u'sysadmin_tblbudget', 'timee',
                      self.gf('django.db.models.fields.CharField')(default='2', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'tblbudget.year'
        db.delete_column(u'sysadmin_tblbudget', 'year')

        # Deleting field 'tblbudget.datee'
        db.delete_column(u'sysadmin_tblbudget', 'datee')

        # Deleting field 'tblbudget.timee'
        db.delete_column(u'sysadmin_tblbudget', 'timee')
