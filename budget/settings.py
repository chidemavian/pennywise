...
DATABASES = {
    'default': {
        ...
        'NAME': 'C:/Windows/www/budgetting/budget/budget.db',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
      ...
      'C:/Windows/www/budgetting/budget/budget/static',
...
SECRET_KEY = ')0_oxz8jvv(6n2#ag64m4*=&do%%h8=1*wfin4sg6g)#---sy^'
